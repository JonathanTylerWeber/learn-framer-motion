...
const CodeEditor = ({ startCode, refresh, noInline }: CodeEditorProps) => {
  ...
  return (
    <LiveProvider
      ...
      key={runAnimation ? "refresh" : "static"}
      noInline={noInline}
    >
      {/* Main container */}
      <div
        className="hidden md:block relative w-full transition-all duration-500"
      ...
      >
        ...
        <div className="absolute inset-x-0 top-[30px] z-10 h-full">
          ...
          <div className="flex flex-row w-full h-full">
            {/* Live Code Editor */}
            <div className="w-1/2 h-full bg-[rgb(5,22,38)]">
              <div className="p-0 m-0">
                <LiveError className="text-red-500 mt-2 border border-red-500 rounded-md px-4 mx-4" />
              </div>
              <LiveEditor
                className="px-4 pt-s bg-[rgb(5,22,38)] w-full h-full max-h-full overflow-auto"
